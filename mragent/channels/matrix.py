...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install mragent-ai[matrix]"
    ) from e

from mragent.bus.events import OutboundMessage
from mragent.channels.base import BaseChannel
from mragent.config.loader import get_data_dir
from mragent.utils.helpers import safe_filename
