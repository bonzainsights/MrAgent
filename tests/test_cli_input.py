...
from mragent.cli import commands
...
def mock_prompt_session():
    ...
    with patch("mragent.cli.commands._PROMPT_SESSION", mock_session), \
         patch("mragent.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("mragent.cli.commands.PromptSession") as MockSession, \
         patch("mragent.cli.commands.FileHistory") as MockHistory, \
